...
SCALAR_TAGS = [
    ...
    'ppo/policy_loss', 'ppo/explained_variance', 'ppo/actual_lr',
    'ppo/minibatch_fraction',
    'critic/outcome_nll', 'critic/outcome_brier', 'critic/derived_win_brier',
    'critic/return_huber', 'critic/terminal_value_mean',
    'critic/return_residual_mean', 'critic/expected_return_mean',
